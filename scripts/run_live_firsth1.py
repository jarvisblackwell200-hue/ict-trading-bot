#!/usr/bin/env python3
"""Run the ICT trading bot live via IBKR — ORIGINAL H1 CONFIG (firsth1).

Preserved H1 sw=10 t=3 skip_days=[0,4] configuration.
The main run_live.py has been switched to M15 sw=5 t=4.

Usage:
    PYTHONPATH=src python scripts/run_live_firsth1.py --port 4002
"""
...
def main() -> None:
    ...
    config = LiveConfig(
        ...
        # H1 strategy config (original "firsth1")
        timeframe="H1",
        swing_length=10,
        confluence_threshold=3,
        skip_days=[0, 4],
        state_file="data/live_state_firsth1.json",
    )
